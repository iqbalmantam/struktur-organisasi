...
with tab_chart:
    ...
    frame_height = st.slider(
        "🖼️ Tinggi maksimal area chart (kalau chart lebih pendek, otomatis menyesuaikan)",
        min_value=300, max_value=1200, value=550, step=50, key="frame_height_slider",
    )
    ...
    try:
        ...
        <div style="position: relative; width: 100%;">
            <div style="
                position: absolute; left: 8px; top: 50%; transform: translateY(-50%); z-index: 10;
